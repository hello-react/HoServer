...
const systemModels = ['Model', 'Api', 'Dictionary', 'Area', 'ServerLog']
...
class ModelManage extends TableLayout {
    constructor() {
        ...
        defTableColumns[1].render = (text, record) => {
            return (
                <ObjectInfo modelMeta={this.state.modelMeta} modelInstance={record} customMeta={this.customMeta} text={text} />
            )
        }
    }
