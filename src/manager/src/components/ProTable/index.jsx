 ...
 * implement a simple one according our function requests.
 */
const ProTable = props => {
    ...
    const handleSearch = (fields) => {
        console.log('oooooooooooooo', fields)
        ...
        for (let i=0; i<searchColumns.length; i++) {
            ...
            if (column.searchFlag === 2 && newParams[column.dataIndex] && newParams[column.dataIndex].indexOf('*') < 0) {
        ...
        <div className="ho_pro_table">
            ...
            {hasToolbar ? (
                <Row>
                    ...
                    <Col span={12} className="ho_tbl_toolbar">
                        {options.density !== false ? (
